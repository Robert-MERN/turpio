...
const SignupPart2 = ({ CJS_KEY }) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (Object.values(errors).every(e => !e))
            handleSignupAPI({ ...signupUserInfo, adminAddingUser: true });
    }
    ...
    return (
        <div className='w-full flex flex-col items-center' >
            ...
            <p
                className={`text-stone-800 font-medium text-[21px] leading-tight  text-center w-[35rem]`}
            >
                Authentication
            </p>
            <form onSubmit={handleSubmit} className='flex flex-col px-6 py-10 w-[35rem] items-center h-fit rounded-lg gap-4 bg-white ' >
                <div className='w-full' >
                    <p className='text-stone-500 text-[15px] mb-6' >
                        Please check inbox. A unique code has been sent to the email address you provided.
                    </p>
                ...
                <div className='w-full' >
                    {time ?
                        ...
                        <p className='text-red-500 text-[14px]'>
                            Code has been expired please click on resend code.
                        </p>
                ...
                <button type='submit' className='px-20 w-full py-[8px] text-white rounded-full text-[16px] font-medium bg-gradient-to-r from-violet-700 to-sky-500 hover:opacity-[0.8] transition-all duration-300' >
                    Verify
                </button>
                ...
                <div className='w-full flex items-center gap-2 ' >
                    ...
                    <button type="button" onClick={discardSignup} className='hover:underline text-blue-600 text-[15px]' >Discard Creating Account</button>
                </div>
