...
const EditProfile = () => {
    ...
    return (
        <div className='w-screen flex justify-center' >
            {cookieUser &&
                <form onSubmit={handleSubmit} className='w-[450px] pt-[40px] pb-[80px] flex flex-col items-center gap-8' >
                    ...
                    <div className='flex justify-between w-full' >
                        ...
                        <button type='button' onClick={() => openModal("logout")} className='border border-red-500 bg-red-500 rounded-full px-[18px] py-[8px] text-white text-[15px] hover:opacity-80 transition-all' >
                            Logout
                        </button>
                    </div>
