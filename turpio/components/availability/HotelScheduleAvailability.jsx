...
const HotelScheduleAvailability = ({ nextLink }) => {
        ...
        switch (unit) {
            case "hrs":
                if (((value * 60) < 60 || (value * 60) > 720)) {
                    error = "Time should range from 1 to 720 min"
                }
                break;
            case "day":
                if ((value * 24 * 60 < 1440 || value > 43200)) {
                    error = "It should be between 1 to 30 days"
                }
        }
        return error;
    }
        ...
        switch (values.eventDuration) {
            case 'custom':
                ...
                if (timeUnit === "hrs") {
                    ...
                    timeInMins = Number(time) * 24 * 60
                    eventDurationUnit = "day";
                }
                break;
            default:
