...
const EventCard = ({ title, time, link, id, eventLinkName, userId, bgColor, borderColor }) => {
  ...
  return (
    <div id="parent-container-event-card" className={`w-[330px] h-fit overflow-hidden rounded-md shadow-default border-t-[6px]  bg-white select-none ${borderColor}`}>
      ...
      <div className='flex flex-col gap-6' >
        ...
        <div>
          ...
          <Link target="__blank" className='hover:underline transition-all' href={`/schedule/${username}/select-date/${eventLinkName}`} >
