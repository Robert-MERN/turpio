...
const CreateEventHotel = ({ nextLink }) => {
    ...
    const handleChange = (e) => {
        if (e.target.name === "nameOfRooms" && !eventLinkEditBool) {
            setValue(prev => ({ ...prev, nameOfRooms: e.target.value, eventLink: `turpio.com/${"muneebsafeer"}/${e.target.value}` }));
                    ...
                    <div className='flex gap-3' >
                        ...
                        <div>
                            ...
                            <div className='text-[14px] text-stone-500' >{
                                value.nameOfRooms && finalselectEventLocation ?
                                    ...
                                    :
                                    value.nameOfRooms ?
                                        `${value.nameOfRooms}, No location given`
                                        :
                                        finalselectEventLocation ?
