...
const CreateEventHotel = ({ nextLink, user }) => {
    ...
    const handleChange = (e) => {
        ...
        if (e.target.name === "nameOfRooms" && !eventLinkEditBool) {
            setValues(prev => ({ ...prev, nameOfRooms: value, eventLink: `turpio.com/${user?.username}/select-date/${value.toLowerCase().replace(/[^a-zA-Z0-9]/g, '-')}` }));
    ...
    const validateField = (fieldName, value) => {
        ...
        switch (fieldName) {
            case 'nameOfRooms':
                if (!value) {
                    error = 'Please enter the name of room.'
            ...
            case 'amountOfRooms':
                if (value < 1) {
                    error = 'Please enter the numbers of rooms.'
                }
                break;
            case 'eventLocation':
                if (!value) {
            ...
            case 'eventLink':
                ...
                } else if (!eventLinkEditBool && !values.nameOfRooms) {
                    error = 'Please enter any event link name.'
                }
                break;
            default:
                    ...
                    <div className='flex gap-3' >
                        ...
                        <div>
                            ...
                            <div className='text-[14px] text-stone-500' >{
                                values.nameOfRooms && finalselectEventLocation ?
                                    ...
                                    :
                                    values.nameOfRooms ?
                                        `${values.nameOfRooms}, No location given`
                                        :
                ...
                <div className='px-[55px] w-[550px] py-[35px] flex gap-6 flex-col min-h-[calc(75vh)]' >
                    ...
                    <div className='w-full' >
                        ...
                        <TextField
                            ...
                            placeholder="Name of Rooms"
                            size='small'
                            onBlur={handleBlur}
                            helperText={values.errors.nameOfRooms}
                            error={Boolean(values.errors.nameOfRooms)}
                    ...
                    <div className='w-full' >
                        ...
                        <TextField
                            ...
                            name="amountOfRooms"
                            onChange={handleChange}
                            value={values.amountOfRooms}
                            size='small'
                            type="number"
                            onBlur={handleBlur}
                            helperText={values.errors.amountOfRooms}
                            error={Boolean(values.errors.amountOfRooms)}
                            inputProps={{
                                min: 1,
                                max: 20,
                                pattern: "[1-9]*"
...
export default CreateEventHotel