...
const CreateEventOneOnOne = ({ nextLink }) => {
    ...
    const handleChange = (e) => {
        if (e.target.name === "eventName" && !eventLinkEditBool) {
            setValue(prev => ({ ...prev, eventName: e.target.value, eventLink: `turpio.com/${"muneebsafeer"}/${e.target.value}` }));
