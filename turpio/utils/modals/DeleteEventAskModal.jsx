...
const DeleteEventAskModal = ({ open, close, targetID, deleteOneEvent }) => {
    return (
        <Dialog
            open={open}
            ...
            <div className='w-[500px] p-7 relative flex flex-col gap-10' >
                ...
                <div className='w-full flex justify-end gap-4' >
                    ...
                    <button
                        onClick={() => {
                            close("deleteEvent");
                            deleteOneEvent(targetID);
                        }}
                        className='bg-stone-600 hover:bg-stone-500 px-4 py-[6px] rounded-md text-white text-[15px] transition-all' >Delete</button>
                </div>
            </div>
        </Dialog>
    )
