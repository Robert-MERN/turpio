...
const EventLocationSelect = ({ error }) => {
    const { anchorEl,
        openTimeZonePopover,
        ...
        eventLocationDialogDefaultValues,
        setEventLocationDialogValues,
        setAdditionalInfoForInput,
        ...
        <div>
            <div
                ...
                ${(!finalselectEventLocation || modals.eventLocation) ? "cursor-pointer" : "cursor-default"}
                 ${open ? (error ? "border-red-700" : "border-blue-500") : (error ? "border-red-600" : "border-stone-300")}`}
            ...
            >
                {modals.eventLocation || finalselectEventLocation ?
                        ...
                        {(finalselectEventLocation && !modals.eventLocation) &&
                            <div className='flex items-center gap-2' >
                                ...
                                <ClearIcon onClick={() => {
                                    ...
                                    setAdditionalInfoForInput(false);
                    ...
                    <div className='w-full flex items-centre justify-between' >
                        ...
                        <>
                            {open ?
                                <KeyboardArrowUpIcon className={`${error ? "text-red-600" : "text-blue-500"}`} />
                                :
                                <KeyboardArrowDownIcon className={`${error ? "text-red-600" : "text-blue-500"}`} />
                            }
                        </>
                    </div>
                }
